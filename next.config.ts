...
const securityHeaders = [
  ...
  { key: "Strict-Transport-Security", value: "max-age=63072000; includeSubDomains; preload" },
  {
    ...
    value: [
      ...
      "media-src 'self' http://localhost http://127.0.0.1 https://cdn.spinxweb.net https://*.trycloudflare.com",
      "frame-src https://www.youtube.com https://www.youtube-nocookie.com",
      "connect-src 'self' http://localhost http://127.0.0.1 https://cdn.jsdelivr.net https://cdn.spinxweb.net https://*.trycloudflare.com",
      "object-src 'none'",
      "base-uri 'self'",
      "form-action 'self'",
